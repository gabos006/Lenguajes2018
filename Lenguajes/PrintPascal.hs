...
instance Print Parts where
  prt i e = case e of
    PPart consts types vars procsyfuncs -> prPrec i 0 (concatD [prt 0 consts, prt 0 types, prt 0 vars, prt 0 procsyfuncs])
...
instance Print ProcsYFuncs where
  prt i e = case e of
    PProcsYFuncsEmpty -> prPrec i 0 (concatD [])
    PIdProcedure id decparms blockprocfun -> prPrec i 0 (concatD [doc (showString "procedure"), prt 0 id, doc (showString "("), prt 0 decparms, doc (showString ")"), doc (showString ";"), prt 0 blockprocfun])
    PIdFunction id1 decparms id2 blockprocfun -> prPrec i 0 (concatD [doc (showString "function"), prt 0 id1, doc (showString "("), prt 0 decparms, doc (showString ")"), doc (showString ":"), prt 0 id2, doc (showString ";"), prt 0 blockprocfun])
