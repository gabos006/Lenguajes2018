...
transInstruction x = case x of
  ...
  PListInstructionWriteln parmss -> failure x
  PListInstructionReadln parmss -> failure x
transParms :: Parms -> Result
transParms x = case x of
  PWritelnParams string -> failure x
...
transType x = case x of
  PTypeEnum -> failure x
  PTypeSubRange -> failure x
  PTypePointer id -> failure x
  PTypeArray -> failure x
  PTypeRecord -> failure x
